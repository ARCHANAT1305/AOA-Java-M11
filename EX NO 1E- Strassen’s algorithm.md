...
## Algorithm
1. Start and read the size n and elements of matrices A and B.
2. If the matrix size is 1×1, multiply the single elements directly (base case).
3. Otherwise, split both matrices into four equal submatrices (A11, A12, A21, A22 and B11, B12, B21, B22).
4. Compute the seven products (M1 to M7) using Strassen’s formulas and derive the four result submatrices (C11, C12, C21, C22).
5. Combine these submatrices to form the final result matrix C, print it, and stop. 
...
<img width="675" height="614" alt="image" src="https://github.com/user-attachments/assets/e420bd4b-f971-4101-8cc7-de4eefdd930d" />
